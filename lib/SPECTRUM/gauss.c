...
#include <math.h>
#include <stdlib.h>
double fgauss(double wave,double res);
...
main(int argc, char *argv[])
{
  ...
  double dlam,lam,start,end,lam0,fac;
...
double fgauss(double wave,double res)
{
  return(exp(-pow(wave/res,2.0))/(res*1.772453851));
}
